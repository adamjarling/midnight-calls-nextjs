...
import SpainPosterGrid from "./PosterGrid";
          ...
          {isEnglish ? (
            <div>
              ...
              <p className="mb-2">
                ...
                to surprise us but instead brings us those recognizable flavors
                of American Blues Rock served with the elegance and expertise
                expected of seasoned musicians who have spent half their lives
                on the road on stages in America and Europe.
              </p>
              <p className="mb-2">
              ...
              <p className="mb-2">
                ...
                “Whaddya,” “Coming Up Roses,” “So Cold,” and their latest track,
                “Since I’ve Been Thinking.” For the latter, they collaborated
                with Chris Grove (Survivor, Joel Hoekstra, Eddie Money, The
                Steepwater Band) on keyboards.
              </p>
              <p>
                ...
                Check the dates to find out where and when their tour will stop
                on the peninsula.
              </p>
            </div>
          ) : (
